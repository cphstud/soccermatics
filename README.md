...
### Problem med trigonometrien løst
problemet med vinklen  fra straffesparkspositionen (108,40) var at man iflg en webside burde man få en vinkel på 45. Men flg formel:<br>
`angle = np.arctan(7.32*x /(x**2 + y**2 - (7.32/2)**2))`
<br>
tilsyneladende var alt for små. 
<p float="left">
<img src="images/angle.png" width="400">
</p>
### Plot likelyhood of scoring given  distance
<p float="left">
<img src="images/scoredist.png" width="400">
</p>
